...
exports.default = function (id, code, tests) {
  var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};

  code = '\n    (function(require, process, child_process, global) {\n      ' + code + '\n    })(() => {}, null, null, null)\n  ';
  var compiledCode = (0, _babelCore.transform)(code, babelOptions);

  var tempFile = __dirname + '/../temp/' + id + '.js';
  var tempTestFile = __dirname + '/../temp/' + id + '.test.js';
  var tempTestLogFile = __dirname + '/../temp/' + id + '.log.js';
